        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center mt-6">
            ...
            <label htmlFor="terms" className="ml-2 block text-sm text-gray-900">
              By submitting this form, you agree that FoodBank may collect, use
              and disclose your personal data, as provided in this application
              form, or (if applicable) obtained by our organisation as a result
              of your membership, for the following purposes in accordance with
              the Personal Data Protection Act 2012: (a) the processing of this
              account registration; and (b) the administration of the account
          ...
          <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
            <div className="relative bg-white p-6 rounded-lg shadow-lg">
              ...
              <p className="mt-2 text-sm text-gray-700">
                The Good Samaritan Food Donation Bill was passed in Parliament
                on 6 August to provide liability waiver for food donors as long
                as they fulfil the following four conditions:
                <ol className="list-decimal list-inside mt-2 text-sm text-gray-700">
                  <li>
                    The food must not be unsafe and unsuitable at the time it
                    was donated.
                  </li>
                  <li>
                    The food donor must inform the recipient of any particular
                    handling requirements to ensure the food remains safe to
                    consume.
                  </li>
                  <li>
                    The food donor must inform the recipient of any time limit
                    within which the food remains safe and suitable.
                  </li>
                  <li>
                    The donor must take all reasonable measures to comply with
