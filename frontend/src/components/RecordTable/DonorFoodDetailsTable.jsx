...
export default function DonorFoodDetailsTable ({ requestID, requestTime, foodName, foodCategory, quantity, producedAt, consumedBy, foodTags, allergens, collectionAddress, beneficiary, beneficiaryContact, status, operatingHours, handleFood, additionalNotes }) {
    return (
