...
export default function BeneficiaryFoodDetailsTable ({ requestID, requestTime, foodName, foodCategory, quantity, producedAt, consumedBy, foodTags, allergens, collectionAddress, donor, donorContact, status, operatingHours, handleFood, additionalNotes }) {
    return (
