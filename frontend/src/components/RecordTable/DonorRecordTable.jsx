            ...
            <table className="table w-full rounded-lg overflow-hidden">
                <thead>
                    <tr className="bg-secondary text-white font-extrabold text-xl">
                        <th className="first:rounded-tl-lg text-center">Donation Time</th>
                ...
                <tbody>
                    {transactions.length > 0 ? transactions.map((item, index) => {
                        ...
                        return (
                            ...
                            >
                                <td className="text-center">{expandedRow !== index ? new Date(item[obj].producedDateTime).toLocaleString() : ""}</td>
