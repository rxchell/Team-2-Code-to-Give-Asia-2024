              ...
              <div className="flex justify-between">
                ...
                <label>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateFormData("servingSize", e.target.value)
                    }
                  />
                </label>
              </div>
              ...
              <div className="justify-between">
                <label>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateFormData("producedDateTime", e.target.value)
                    }
                  />
                </label>
              </div>
              ...
              <div className="justify-between">
                <label>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateFormData("consumedBy", e.target.value)
                    }
                  />
                </label>
              </div>
